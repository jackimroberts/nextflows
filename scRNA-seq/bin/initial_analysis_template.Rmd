...
for (sample_tuple in collected_cellranger) {
  ...
  # extract cellranger output path (second element of tuple)
  cellranger_paths <- c(cellranger_paths, sample_tuple[[2]])
}
